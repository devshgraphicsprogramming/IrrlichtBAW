...
*/
	...
	public:
        ...
        /*
         * \brief Interface to extract data out of a given mesh buffer
         * \details Gets information about a mesh buffer, can be used for things like trimesh loaders
         * \param output The vector that the extracted data shall reside in
         * \param attrId Specification of what kind of information to be extracted from the mesh buffer
         * \param ix Index of the attribute, can be thought of like an index in an array, and the array having the mesh data
         */
