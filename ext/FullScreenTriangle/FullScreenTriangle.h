...
inline video::IGPUMeshBuffer* createFullScreenTriangle(video::IVideoDriver* driver)
{
    ...
    desc->setVertexAttrBuffer(buff,asset::EVAI_ATTR0,asset::EF_R8G8_SSCALED,sizeof(ScreenTriangleVertexStruct),0);
    desc->setVertexAttrBuffer(buff,asset::EVAI_ATTR1,asset::EF_R8G8_SSCALED,sizeof(ScreenTriangleVertexStruct),offsetof(ScreenTriangleVertexStruct,TexCoord[0]));
